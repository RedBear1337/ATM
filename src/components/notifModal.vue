...
<!--      <img class="mess__icon" alt="" :src="'../assets/svg/notifications/'+notifType+'.svg'">-->
<!--      <img v-if="notifType === 'succ'" class="mess__icon" alt="" src="../assets/svg/notifications/succ.svg">-->
...
<!--      <img  class="mess__icon" alt="" src="../assets/svg/notifications/fail.svg">-->
    ...
    <button class="mess__btn" @click="$bvModal.hide('notif')">Ok</button>
  </div>
  </b-modal>
</template>
